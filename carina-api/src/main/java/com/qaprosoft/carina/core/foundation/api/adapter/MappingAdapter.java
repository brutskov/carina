...
//
//            String path = globalPath != null
//                    ? buildPath(globalPath, apiMethodPreparator.getPath())
//                    : apiMethodPreparator.getPath();
//
//            boolean nullPropertiesPath = apiMethodPreparator.getPropertiesPath() == null;
////            apiMethod = nullPropertiesPath
////                    ? new MethodBasedApiMethod(apiMethodPreparator.getRequestTemplatePath(), apiMethodPreparator.getResponseTemplatePath(), new Properties(), methodType, path)
////                    : new MethodBasedApiMethod(apiMethodPreparator.getRequestTemplatePath(), apiMethodPreparator.getResponseTemplatePath(), apiMethodPreparator.getPropertiesPath(), methodType, path);
//            apiMethod = nullPropertiesPath
